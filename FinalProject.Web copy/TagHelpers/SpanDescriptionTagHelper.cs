...
namespace FinalProject.Web.TagHelpers
{
	...
	/// Useful for Help text
	/// implementation done with &lt;span asp-description-for=...
	/// may be useful to migrate into a package
	/// </summary>
	...
	public class SpanDescriptionTagHelper : TagHelper
    {
		...
		/// <summary>
		/// Generator for creating an HTML element use as &gt;sort-display model-type="xyz" ...
		/// </summary>
		...
		/// <summary>
		/// Create a new <see cref="SpanDescriptionTagHelper"/> 
		/// </summary>
		/// <param name="generator">The <see cref="IHtmlGenerator"/> for creating the tag</param>
		...
		public override void Process(TagHelperContext context, TagHelperOutput output)
		{
			...
			var metadata = (DescriptionFor?.Metadata) ?? throw new InvalidOperationException(string.Format("No provided metadata ({0})", DescriptionForAttributeName));
